package com.atguigu.nrpt.demonrptauthserver02.app;
...
import com.atguigu.nrpt.demonrptauthserver02.feign.MemberFeignService;
import com.atguigu.nrpt.demonrptauthserver02.feign.ThirdPartFeignService;
...
public class LoginController {
    ...
    public String regist(@Valid UserRegistVo vo, BindingResult result, RedirectAttributes redirectAttributes) {
        if (result.hasErrors()) {
            ...
            return "redirect:http://auth.nrpt.com/reg.html";
        }
        //1.校验验证码
        ...
        if (!StringUtils.isEmpty(s)) {
            if (code.equals(s.split("_")[0])) {
                ...
                if (r.getCode() == 0) {
                    //注册成功
                    return "redirect:http://auth.nrpt.com/login.html";
                } else {
